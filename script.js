let bars = [];
const def = "#fd0081", //pink
  chng = "#061957", //blue
  finished = "#82f50f", //green
  selected = "#f5f50f"; //yellow

window.onload = setup();

async function setup() {
  let b = document.getElementById("bars"); //get no. of bars
  let d = document.getElementById("delay"); //get delay
  document.getElementById("b").innerText = b.value; //display no. of bars
  document.getElementById("d").innerText = d.value + "ms"; //display delay
